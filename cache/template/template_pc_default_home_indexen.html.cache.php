...
<html lang="en">
  ...
  <body>
    <?php $menucolor=dr_site_value( 'cdbjs');?>
        ...
        <nav class="h-[100%] flex w-[100%] justify-between px-[80px] items-center">
          ...
          <div class="flex">
            <ul>
              ...
              <li>
                <a class="" target="_blank" href="<?php echo $discord; ?>">
                  <img class="discord" src="/template/pc/default/home/static/image/discord.png" alt="" style="width:30px;">
                </a>
              </li>
              <li>
                <a class="" target="_blank" href="<?php echo $opensea; ?>">
                  <img class="OpenSea" src="/template/pc/default/home/static/image/OpenSea-fill.png" alt="" style="width:30px;">
                </a>
              </li>
              <li>
                <div class="relative">
                  <div class="menu current-locale flex justify-center items-center cursor-pointer">
                    <span class="language mr-[4px] font-black">EN</span>
                  </div>
                  <div style="display:none;" class="menu-list dropdown absolute -top-[8px] -left-[18px] w-[78px] h-[64px] p-[4px] rounded-[6px] bg-white shadow-[0_1.55952px_3.11905px_rgba(0,0,0,0.2)] transition">
                    <a href="/index.php?en">
                      <div class="item text-black h-[26px] flex items-center rounded-[4px] transition hover:bg-black hover:text-white">
                        <div class="w-[24px] text-center">
                          <svg viewBox="0 0 14 10" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="h-[10px]">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M13 2.297A1.2 1.2 0 0 0 11.303.6L5.4 6.503 2.697 3.8A1.2 1.2 0 0 0 1 5.497L4.55 9.048a1.198 1.198 0 0 0 1.698 0L13 2.299Z">
                            </path>
                          </svg>
                        </div>
                        <div>
                    ...
                    <a href="/index.php">
                      <div class="item text-black h-[26px] flex items-center rounded-[4px] transition hover:bg-black hover:text-white mt-[4px]">
                        <div class="w-[24px] text-center">
                        </div>
                        <div>
          ...
          <?php $bannercolor=dr_site_value( 'sybannerbjys');?>
            <div class="video-bg overflow-hidden" style="background-color: <?php echo $bannercolor; ?>;">
              ...
              text-align: center;color: #fff;">
                <?php $mytitle=dr_site_value( 'bannerzbt'); echo $mytitle; ?></div>
              <?php $myhdtp=dr_site_value( 'shouyebanner'); $hdtp = current($myhdtp); ?>
                <img src="<?php echo dr_get_file($hdtp); ?>" alt="" class="w-full align-top rounded-b-[60px] overflow-hidden" style="border-radius:0;"></div>
            <div class="cheers_up__scroll_text h-[40px] bg-[url(&#x27;/template/pc/default/home/img/cheers-up/scrolltext1x.jpg&#x27;)] bg-contain bg-repeat-x animate-[scrollx_2s_linear_infinite] transform-gpu">
            </div>
              ...
              <div class="w-[55.25%] mr-[3.52%]">
                <span style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%">
                  <?php $myxmjjzt=dr_site_value( 'xmjjzt'); $jzt = current($myxmjjzt); ?>
                    <img alt="cheersup" src="<?php echo dr_get_file($jzt); ?>" style="width:100%;"></span>
              </div>
              <div class="w-[42.97%] min-w-[420px]">
                <div class="text-[14px] leading-[22px] mb-[32px] text-black font-[&quot;Roboto&quot;]">
                  <div class="title">Project introduction</div>
                  <br/>
                  <?php $mysite=dr_site_value('xmjjyw'); echo $mysite; ?>
                    <br></div>
              ...
              <div class="two container">
                <?php $myxmjjyt=dr_site_value( 'xmjjyt'); $jyt = current($myxmjjyt); ?>
                  ...
                  <div class="w-[42.97%] mr-[5%]">
                    <div class="two title">MORE</div>
                    <div class="text-black text-[14px] leading-[22px] mt-[40px] font-[&quot;Roboto&quot;]">
                      <div class="mt-[40px]">
                        <?php $moretxt=dr_site_value('ywxmjjgd'); echo $moretxt; ?></div>
                    </div>
                  </div>
              </div>
            </div>
            <?php $threebg=dr_site_value('cyweb3bjs');?>
              <div class="w-full left-0 top-0 pt-[80px] pb-[100px]" style="background-color:<?php echo $threebg; ?>">
                <div class="three container">
                  <div class="three title">Enjoy Web3</div>
                  <div>
                    <div class="style_roadmap-item__JBIDt" style="color:#FFC045">
                            ...
                            <div class="MuiCollapse-wrapperInner MuiCollapse-vertical css-8atqhb">
                              <div role="region" class="MuiAccordion-region">
                                <div class="MuiAccordionDetails-root style_roadmap-body__KhT2q css-u7qq7e" style="background-color:#FFC045">
                                  <?php $web3sm=dr_site_value('ywcyweb3lbsm'); echo $web3sm; ?></div>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="style_roadmap-shadow-title__mcQnu">
                        <div>
                          ...
                          <span class="style_text__EIkOQ text-white">Mission</span>
                        </div>
                    ...
                    <div class="style_roadmap-item__JBIDt" style="color:#F6E3D8">
                            ...
                            <div class="MuiCollapse-wrapperInner MuiCollapse-vertical css-8atqhb">
                              <div role="region" class="MuiAccordion-region">
                                <div class="MuiAccordionDetails-root style_roadmap-body__KhT2q css-u7qq7e" style="background-color:#F6E3D8">
                                  <?php $web3yyzst=dr_site_value( 'ywcyweb3yyzst'); echo $web3yyzst; ?></div>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="style_roadmap-man__1Imib">
                        <span style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%">
                          <span style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%">
                            <img class="man-1" alt="" aria-hidden="true" src="/template/pc/default/home/static/roadmap/man/2.png">
                          </span>
                        </span>
                      </div>
                      <div class="style_roadmap-shim__d4_M7">
                      ...
                      <div class="style_roadmap-shadow-title__mcQnu">
                        <div>
                          ...
                          <span class="style_text__EIkOQ text-white">Metacosmic ecology</span>
                        </div>
                        <div class="style_open__mXmIr">
                          <img alt="open" src="/template/pc/default/home/static/roadmap/open.svg" class="opentianwei">
                        </div>
                    ...
                    <div class="style_roadmap-item__JBIDt" style="color:#FE8FB4">
                            ...
                            <div class="MuiCollapse-wrapperInner MuiCollapse-vertical css-8atqhb">
                              <div role="region" class="MuiAccordion-region">
                                <div class="MuiAccordionDetails-root style_roadmap-body__KhT2q css-u7qq7e" style="background-color:#FE8FB4">
                                  <?php $web3sqjs=dr_site_value('ywcyweb3sqjs'); echo $web3sqjs; ?></div>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="style_roadmap-man__1Imib">
                        <span style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%">
                          <span style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%">
                            <img class="man-1" alt="" aria-hidden="true" src="/template/pc/default/home/static/roadmap/man/3.png">
                          </span>
                        </span>
                      </div>
                      <div class="style_roadmap-shim__d4_M7">
                      ...
                      <div class="style_roadmap-shadow-title__mcQnu">
                        <div>
                          ...
                          <span class="style_text__EIkOQ text-white">Community construction</span>
                        </div>
                        <div class="style_open__mXmIr">
                          <img alt="open" src="/template/pc/default/home/static/roadmap/open.svg" class="opentianwei">
                        </div>
                    ...
                    <div class="style_roadmap-item__JBIDt" style="color:#FFAD92">
                            ...
                            <div class="MuiCollapse-wrapperInner MuiCollapse-vertical css-8atqhb">
                              <div role="region" class="MuiAccordion-region">
                                <div class="MuiAccordionDetails-root style_roadmap-body__KhT2q css-u7qq7e" style="background-color:#FFAD92">
                                  <?php $web3IPjs=dr_site_value('ywcyweb3ipjs'); echo $web3IPjs; ?></div>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="style_roadmap-shadow-title__mcQnu">
                        <div>
                          ...
                          <span class="style_text__EIkOQ">IP build</span>
                        </div>
                        <div class="style_open__mXmIr">
                          <img alt="open" src="/template/pc/default/home/static/roadmap/open.svg" class="opentianwei">
                        </div>
                    ...
                    <div class="style_roadmap-item__JBIDt" style="color:#91DDF3">
                            ...
                            <div class="MuiCollapse-wrapperInner MuiCollapse-vertical css-8atqhb">
                              <div role="region" class="MuiAccordion-region">
                                <div class="MuiAccordionDetails-root style_roadmap-body__KhT2q css-u7qq7e" style="background-color:#91DDF3">
                                  <?php $web3sqfl=dr_site_value('ywcyweb3sqfl'); echo $web3sqfl; ?></div>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="style_roadmap-man__1Imib">
                        <span style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%">
                          <span style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%">
                            <img class="man-1" alt="" aria-hidden="true" src="/template/pc/default/home/static/roadmap/man/6.png">
                          </span>
                        </span>
                      </div>
                      <div class="style_roadmap-shim__d4_M7">
                      ...
                      <div class="style_roadmap-shadow-title__mcQnu">
                        <div>
                          ...
                          <span class="style_text__EIkOQ">Community welfare</span>
                        </div>
                        <div class="style_open__mXmIr">
                          <img alt="open" src="/template/pc/default/home/static/roadmap/open.svg" class="opentianwei">
                        </div>
                    ...
                    <div class="style_roadmap-item__JBIDt box-shadow-none" style="color:#97A1FC">
                            ...
                            <div class="MuiCollapse-wrapperInner MuiCollapse-vertical css-8atqhb">
                              <div role="region" class="MuiAccordion-region">
                                <div class="MuiAccordionDetails-root style_roadmap-body__KhT2q css-u7qq7e" style="background-color:#97A1FC">
                                  <?php $web3cyjz=dr_site_value('ywcyweb3cyjz'); echo $web3cyjz; ?></div>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="style_roadmap-shadow-title__mcQnu">
                        <div>
                          ...
                          <span class="style_text__EIkOQ">Long term value</span>
                        </div>
                        <div class="style_open__mXmIr">
                          <img alt="open" src="/template/pc/default/home/static/roadmap/open.svg" class="opentianwei">
                        </div>
              ...
              <?php $fourbg=dr_site_value('fzlcbjs');?>
                <div class="w-full left-0 top-0 pb-[100px]" style="background-color:<?php echo $fourbg; ?>">
                  <div class="four container">
                    ...
                    <?php $fzlczt=dr_site_value('fzlcywpt'); $fzlczt1 = current($fzlczt); ?>
                      <div id="tianwei" class="MuiCollapse-root MuiCollapse-vertical MuiCollapse-hidden" style="text-align: center;">
                        <img src="<?php echo dr_get_file($fzlczt1); ?>" alt="" class="" style="padding-top:50px;padding-bottom:50px;padding-top: 50px;padding-bottom: 50px;width: 80%;
                        padding-left: 5%;
                        padding-right: 5%;"></div>
                  </div>
                </div>
                <?php $mytuandui=dr_site_value('tuanduipeitu'); $tuanduibg=dr_site_value('tdbjs');?>
                    <div class="w-full left-0 top-0 pt-[80px] pb-[100px]" style="background-color:<?php echo $tuanduibg; ?>;"><?php $tuandui = current($mytuandui); ?>
                      ...
                      background-repeat: no-repeat;">
                        <?php $tuanduiwenzi=dr_site_value('ywtdwz'); echo $tuanduiwenzi; ?></div>
                    </div>
      </div>
            ...
            <article class="text-white pt-[110px] text-center" style="background-color:<?php echo $footerbg; ?>;height:auto;">
              <a href="/">
                <?php $footimage=dr_site_value( 'yejiaozhutu'); $footimg = current($footimage); ?>
                  <img src="<?php echo dr_get_file($footimg); ?>" alt="" class=""></a>
              <div class="justify-start left-[120px]" style="padding-top: 5%;padding-bottom: 5%;">
                <?php $twitter=dr_site_value( 'twitter'); $opensea=dr_site_value( 'opensea'); $discord=dr_site_value( 'discord');?>
                      <a class="padding-10" target="_blank" href="<?php echo $twitter; ?>">
                        <img src="/template/pc/default/home/static/image/tuite.png" alt="">
                      </a>
                      <a class="padding-10" target="_blank" href="<?php echo $discord; ?>">
                        <img src="/template/pc/default/home/static/image/discord.png" alt="">
                      </a>
                      <a class="padding-10" target="_blank" href="<?php echo $opensea; ?>">
                        <img src="/template/pc/default/home/static/image/OpenSea-fill.png" alt="">
                      </a>
              </div>
      ...
      <script src="/template/pc/default/home/static/js/index.js">
      </script>
  </body>
